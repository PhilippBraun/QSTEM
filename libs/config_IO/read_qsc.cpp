...
void ModelConfig::Read(ptree& t){
	...
	zOffset=t.get<float_tt>("model.zOffset");
	resolutionXAngstrom=t.get<float_tt>("model.resolutionXAngstrom");
	resolutionYAngstrom=t.get<float_tt>("model.resolutionYAngstrom");
	crystalTiltX=t.get<float_tt>("model.crystalTiltX");
	crystalTiltY=t.get<float_tt>("model.crystalTiltY");
...
void OutputConfig::Read(ptree& t){
	...
	SaveFolder=t.get<string>("output.folder");
